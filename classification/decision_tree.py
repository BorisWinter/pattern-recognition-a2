...
def decision_tree(data, labels, depth=5, calculation="entropy"):
    ...
    clf = DecisionTreeClassifier(criterion=calculation, max_depth=depth)
...
def cross_val_decision_tree(data, labels, cv=5, depth=5, calculation="entropy"):
    # Create Decision Tree classifer object
    clf = DecisionTreeClassifier(criterion=calculation, max_depth=depth)
